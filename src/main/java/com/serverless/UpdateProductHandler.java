...
public class UpdateProductHandler implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {
    ...
    public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
        ...
        try {
            ...
            Product updatedResponse = product.update(productId, product);

            // send the response back
            return ApiGatewayResponse.builder()
                    .setStatusCode(200)
                    .setObjectBody(updatedResponse)
